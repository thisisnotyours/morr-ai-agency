...
const Logos3 = ({
  ...
  return (
    <section className="py-0"> {/* 기존 py-16에서 py-8로 더 줄임 */}
      ...
      <div className="pt-0 md:pt-0.5 "> {/* 기존 pt-0 md:pt-1 lg:pt-4에서 더 줄임 */}
      ...
      <style jsx>{`
        ...
        .headline {
          ...
          font-size: 1rem; /* 기본 폰트 사이즈를 1rem으로 설정 */
          font-weight: 400;
          color: #6b7280;
        ...
        @media (max-width: 1024px) {
          .headline {
            font-size: 1.1rem; /* 1024px 이하에서도 1rem 유지 */
          }
        }

        @media (max-width: 768px) {
          .headline {
            font-size: 1.1rem; /* 768px 이하에서도 1rem 유지 */
          }
        }

        @media (max-width: 480px) {
          .headline {
            font-size: 1rem; /* 모바일에서도 1rem 유지 */
          }
        }
      `}</style>
    </section>
